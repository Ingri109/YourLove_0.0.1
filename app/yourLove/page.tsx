  ...
  return (
    <>
      <div className="flex justify-center items-center justify-items-stretch">
        <div className=" flex flex-col justify-between items-center max-h-full px-[16px] py-[12px] bg-color1_2 bg-opacity-10 backdrop-blur-md mt-[80px] mx-[20px] rounded-[10px] shadow-[0_15px_30px_7px_rgba(0,0,0,0.35)] lg:px-[28px] lg:py-[12px] lg:flex-row md:px-[12px] md:py-[18px] md:mx-0 animate-scaleIn">

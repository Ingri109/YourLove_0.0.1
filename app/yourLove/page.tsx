  ...
  return (
    <>
      <div className="flex justify-center items-center justify-items-stretch">
        <div className=" flex flex-col justify-between items-center max-h-full w-11/12 px-[10px] py-[12px] bg-color1_2 bg-opacity-10 backdrop-blur-md mt-[80px] mx-[20px] rounded-[10px] shadow-[0_15px_30px_7px_rgba(0,0,0,0.35)] lg:px-[28px] lg:py-[12px] lg:flex-row lg:w-auto md:px-[12px] md:py-[18px] md:mx-0 animate-scaleIn">
          <div className="flex flex-col justify-start justify-items-stretch items-start  bg-color1_1 rounded-[14px] w-full h-[548px] shadow-[0_5px_10px_3px_rgba(0,0,0,0.5)] lg:w-[460px] lg:h-[548px] md:w-4/5">

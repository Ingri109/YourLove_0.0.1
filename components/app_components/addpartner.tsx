    ...
    return (
        <>
            <div className="basis-0 flex flex-col justify-center items-center justify-items-stretch mt-[36px] lg:basis-1/2 lg:mt-[0px] ">
                <p className="text-[12px] text-white font-normal text-balance tracking-normal hyphens-manual text-center ml-[10px] mr-[10px] xl:text-[16px] lg:text-[14px] lg:mr-[30px] lg:ml-[0px] font-Source">Доброго дня, дякую за те що скористувалися нашою інтернет сторінкою, якщо ви хочете добачити <span className="text-color3 font-bold">Cвого Партнера</span> для цікавого проведення спільного часу на цій сторінці будь ласка можете вести <span className="text-color3 font-bold">ID</span> вашого партнера, він знаходиться на сторінці Акаунта його сторінки, після чого натиснути на кнопку <span className="text-color3 font-bold">Добавити партнера</span>.
                    Або прийміть запрошення від вашого партнера натиснувши на кнопку <span className="text-color3 font-bold">Запрошення</span>.
                </p>
                <p className="text-[9px] text-white font-normal text-wrap tracking-normal hyphens-manual text-center mt-[15px] ml-[10px] mr-[10px] lg:text-[12px] lg:mr-[10px] lg:ml-[0px] font-Source"><span className="text-[11px] text-color3_2 font-extrabold text-wrap tracking-normal lg:[12px]">ПОПЕРЕДЖЕННЯ: </span>Може бути добавлений лише <span className=" underline uppercase underline-offset-3 decoration-white"> одиного партнера</span> , якщо ви хочете його змінити в майбутньому, то потрібно натиснути на кнопку <span className=" font-semibold text-color3">Покинути партнера</span>.</p>

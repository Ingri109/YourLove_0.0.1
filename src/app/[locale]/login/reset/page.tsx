    ...
    return (
        <>
            <div className="h-screen flex items-center justify-center p-6">
                <div className="flex flex-col items-center justify-starts bg-color3_3 rounded-lg shadow-md bg-opacity-40 backdrop-blur-[12px] px-6 py-3 md:px-8 md:py-6 sm:w-auto ">
                    <h1 className="text-white text-nowrap text-center font-bold text-[16px] sm:text-[22px]">Зміна пароля</h1>
                    <h1 className="text-white text-nowrap text-center font-bold text-[12px] sm:text-[16px]">Будь ласка введіть новий пароль</h1>
